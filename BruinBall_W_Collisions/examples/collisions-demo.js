...
export class Body {
    ...
    check_if_colliding(b, collider) {
        ...
        //this.inverse = Mat4.inverse(Mat4.translation(b.center[0], b.center[1], b.center[2]));
        const T = this.inverse.times(Mat4.translation(b.center[0], b.center[1], b.center[2]));
...
export class Simulation extends Scene {
    ...
    simulate(frame_time) {
       ...
       // for (let b of this.bodies) b.drawn_location = b.center.copy().to4(1);  
    }
    ...
    display(context, program_state) {
        ...
        for (let b of this.bodies){
            ...
            b.shape.draw(context, program_state, Mat4.translation(b.center[0], b.center[1],b.center[2]), b.material); 
        }
    }
